...
using Scada.Comm.Drivers.DrvFreeDiskSpaceJP.View.Forms;
...
namespace Scada.Comm.Drivers.DrvFreeDiskSpaceJP.View
{
    ...
    /// </summary>
    internal class DevFreeDiskSpaceJPView : DeviceView
    {
        ...
        /// </summary>
        public DevFreeDiskSpaceJPView(DriverView parentView, LineConfig lineConfig, DeviceConfig deviceConfig)
