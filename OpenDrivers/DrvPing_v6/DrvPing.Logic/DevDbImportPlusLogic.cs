...
namespace Scada.Comm.Drivers.DrvPingLogic.Logic
{
    /// <summary>
    ...
    internal class DevDbImportPlusLogic : DeviceLogic
    {
        ...
        private static List<string> hosts;                      // hosts
            ...
            : base(commContext, lineContext, deviceConfig)
        {
            ...
            string shortFileName = DrvPingConfig.GetFileName(deviceNum);
        ...
        {
            // load configuration
            DrvPingConfig config = new DrvPingConfig();
