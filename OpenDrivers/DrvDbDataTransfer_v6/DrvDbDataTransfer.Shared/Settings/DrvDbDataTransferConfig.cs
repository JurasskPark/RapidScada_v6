...
namespace Scada.Comm.Drivers.DrvDbDataTransfer
{
    ...
    /// </summary>
    public class DrvDbDataTransferProject : DeviceConfigBase
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvDbDataTransferProject()
        {
            SetToDefault();
        }
        ...
        public new bool Save(string fileName, out string errMsg)
        {
            try
            {
                ...
                XmlElement rootElem = xmlDoc.CreateElement("DrvDbDataTransferProject");
