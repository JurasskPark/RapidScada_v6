...
namespace Scada.Comm.Drivers.DrvTextParserInDatabaseJP
{
    ...
    public class DatabaseCommand : IDisposable
    {
        ...
        /// </summary>
        public static DrvDbDataTransferProject project = new DrvDbDataTransferProject();
        ...
        /// <param name="errMsg">Error message if the connection fails.</param>
        /// <returns>True if the connection is successful; otherwise, False.</returns>
        public bool ConnectionTest(DrvDbDataTransferProject project, out string errMsg)
        {
        ...
        /// </summary>
        public DbTransferResult Transfer(DrvDbDataTransferProject project, ImportCmd cmd)
        {
