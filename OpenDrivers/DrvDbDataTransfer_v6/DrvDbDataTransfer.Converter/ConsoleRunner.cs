...
namespace Scada.Comm.Drivers.DrvDbDataTransfer.Converter
{
    ...
    internal sealed class ConsoleRunner
    {
        ...
        {
            Console.WriteLine("DrvDbDataTransfer old project converter");
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine("  DrvDbDataTransfer.Converter <source-config-dir-or-xml> [output-config-dir] [--overwrite]");
            Console.WriteLine();
            ...
            Console.WriteLine(@"  DrvDbDataTransfer.Converter C:\SCADA\ProjectSamples\HelloWorld_Database\Instances\Default\ScadaComm\Config C:\Temp\DrvDbDataTransferConverted");
        }
