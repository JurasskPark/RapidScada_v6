...
{
    /// <summary>
    /// Converts old DrvDbDataTransfer configuration files to the current format.
    /// <para>Конвертирует старые файлы конфигурации DrvDbDataTransfer в текущий формат.</para>
    /// </summary>
    internal sealed class ProjectConverter
    {
        ...
        private static void ConvertFile(string sourceFileName, string outputPath, ConverterOptions options)
        {
            ...
            DrvDbDataTransferProject project = ConvertProject(rootElem);
            ...
            DrvDbDataTransferProject savedProject = new DrvDbDataTransferProject();
        ...
        private static DrvDbDataTransferProject ConvertProject(XmlElement rootElem)
        {
