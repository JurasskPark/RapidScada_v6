...
namespace Scada.Comm.Drivers.DrvDbDataTransferLogic.Logic
{
    /// <summary>
    /// Implements the device logic.
    /// <para>Реализует логику устройства.</para>
    /// </summary>
    internal class DevDbDataTransferLogic : DeviceLogic
    {
        ...
        private readonly DrvDbDataTransferProject project;       // the device configuration
        ...
        /// </summary>
        public DevDbDataTransferLogic(ICommContext commContext, ILineContext lineContext, DeviceConfig deviceProject)
        ...
        /// </summary>
        public void InitDataSource(DrvDbDataTransferProject project)
        {
