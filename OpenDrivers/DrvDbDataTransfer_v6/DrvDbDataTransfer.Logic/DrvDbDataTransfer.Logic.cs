...
using Scada.Comm.Drivers.DrvDbDataTransferLogic.Logic;

namespace Scada.Comm.Drivers.DrvDbDataTransfer.Logic
{
    ...
    /// </summary>
    public class DrvDbDataTransferLogic : DriverLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvDbDataTransferLogic(ICommContext commContext)
            : base(commContext)
        {
        }
