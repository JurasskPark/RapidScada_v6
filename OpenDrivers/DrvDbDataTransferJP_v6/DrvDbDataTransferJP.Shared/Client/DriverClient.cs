...
namespace Scada.Comm.Drivers.DrvDbDataTransferJP
{
    ...
    internal class DriverClient : IDisposable
    {
        ...
        private readonly DrvDbDataTransferJPProject project;                  // configuration
        ...
        public DriverClient(string path, DrvDbDataTransferJPProject project, int deviceNum, string pathLog, bool isDll)
        {
            this.pathProject = path;
            this.project = project ?? new DrvDbDataTransferJPProject();
