...
namespace Scada.Comm.Drivers.DrvDbDataTransferJP
{
    ...
    {
        #region Variables
        public static DrvDbDataTransferJPProject project = new DrvDbDataTransferJPProject();                         // the project configuration
        ...
        /// Recording log
        /// </summary>
        public static void Log(string text, bool writeDateTime = true)
        {
            try
            {
                string errMsg = string.Empty;
                ...
                if (Manager.IsDll)
                {
                    if (project.DebugerSettings.LogWrite)
                    {
                        ...
                        debugerReturn.Log(text, writeDateTime);
                    }
                }
