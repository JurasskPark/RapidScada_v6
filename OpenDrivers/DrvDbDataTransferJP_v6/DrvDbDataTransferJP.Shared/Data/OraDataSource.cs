...
namespace Scada.Comm.Drivers.DrvDbDataTransferJP
{
    ...
    internal class OraDataSource : DataSource
    {
        ...
        /// <summary>
        /// Converts UI-style SQL parameters to Oracle-style parameters.
        /// </summary>
        public override string NormalizeCommandText(string commandText)
        {
            return ReplaceParameterPrefix(commandText, ':');
        }

        /// <summary>
        /// Converts UI-style parameter names to Oracle-style parameter names.
        /// </summary>
