...
namespace Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms
{
    ...
    public partial class FrmProject : Form
    {
        ...
        public FrmProject()
        {
            ...
            this.project = new DrvDbDataTransferJPProject();
            ...
            : this()
        {
            ...
            project = new DrvDbDataTransferJPProject();
        ...
        public readonly DrvDbDataTransferJPProject project; // the device configuration
        ...
        public void LoadLanguage(string languageDir, bool IsRussian = false)
        {
            ...
            Locale.GetDictionary("Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms.FrmProject");
            Locale.GetDictionary("Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms.FrmImportCmd");
            Locale.GetDictionary("Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms.FrmExportCmd");
            Locale.GetDictionary("Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms.FrmInputBox");
            Locale.GetDictionary("Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms.FrmTag");
