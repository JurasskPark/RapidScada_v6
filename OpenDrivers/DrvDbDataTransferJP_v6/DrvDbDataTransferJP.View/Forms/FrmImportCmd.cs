...
using static Scada.Comm.Drivers.DrvDbDataTransferJP.DriverTag;
...
namespace Scada.Comm.Drivers.DrvDbDataTransferJP.View.Forms
{
    ...
    public partial class FrmImportCmd : Form
    {
        ...
        public DrvDbDataTransferJPProject project;                // the configuration
        ...
        private void ProjectToControls()
        {
            if (cmd != null)
            {
                ...
                fctCmdQuery.Text = cmd.SelectQuery;
                fctInsertQuery.Text = cmd.InsertQuery;
                chkStopOnError.Checked = cmd.StopOnError;
                nudBatchSize.Value = cmd.BatchSize;
        ...
        private void ControlsToProject()
        {
            ...
            cmd.SelectQuery = fctCmdQuery.Text;
            cmd.InsertQuery = fctInsertQuery.Text;
            cmd.StopOnError = chkStopOnError.Checked;
            cmd.BatchSize = Convert.ToInt32(nudBatchSize.Value);
        ...
        {
            GetActiveSqlEditor().Selection.SelectAll();
        }
        ...
        {
            FastColoredTextBox editor = GetActiveSqlEditor();
        ...
        {
            FastColoredTextBox editor = GetActiveSqlEditor();
            if (editor.RedoEnabled)
            {
                editor.Redo();
            }
        }

        private FastColoredTextBox GetActiveSqlEditor()
        {
            return cmnuMenuScriptQuery.SourceControl as FastColoredTextBox ?? fctCmdQuery;
        }
