...
```text
DrvDbDataTransferJP_v6/
├── DrvDbDataTransferJP.sln
├── StartСompiling.bat
├── README.md
├── DrvDbDataTransferJP.Logic/       # runtime driver for ScadaComm
├── DrvDbDataTransferJP.View/        # ScadaAdmin UI
├── DrvDbDataTransferJP.Shared/      # shared settings, database, tag and utility code
├── DrvDbDataTransferJP.Winform/     # standalone WinForms test/admin app
├── DrvDbDataTransferJP.Converter/   # old XML converter
└── DrvDbDataTransferJP.Tests/       # lightweight regression tests
```
...
![DrvDbDataTransferJP](https://raw.githubusercontent.com/JurasskPark/RapidScada_v6/refs/heads/master/Source/DrvDbDataTransferJP_001.png)
![DrvDbDataTransferJP](https://raw.githubusercontent.com/JurasskPark/RapidScada_v6/refs/heads/master/Source/DrvDbDataTransferJP_002.png)
