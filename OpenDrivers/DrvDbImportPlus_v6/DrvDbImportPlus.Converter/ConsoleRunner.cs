...
namespace Scada.Comm.Drivers.DrvDbImportPlus.Converter
{
    ...
    internal sealed class ConsoleRunner
    {
        ...
        {
            Console.WriteLine("DrvDbImportPlus old project converter");
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine("  DrvDbImportPlus.Converter <source-config-dir-or-xml> [output-config-dir] [--overwrite]");
            Console.WriteLine();
            ...
            Console.WriteLine(@"  DrvDbImportPlus.Converter C:\SCADA\ProjectSamples\HelloWorld_Database\Instances\Default\ScadaComm\Config C:\Temp\DrvDbImportPlusConverted");
        }
