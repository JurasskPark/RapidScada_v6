...
namespace Scada.Comm.Drivers.DrvDbImportPlus.Converter
{
    ...
    internal static class ConversionConstants
    {
        ...
        /// </summary>
        public const string OldRootName = "DrvDbImportPlusConfig";

        /// <summary>
        /// The new configuration root element.
        /// </summary>
        public const string NewRootName = "DrvDbImportPlusProject";

        /// <summary>
        /// The driver configuration file search pattern.
        /// </summary>
        public const string FileSearchPattern = "DrvDbImportPlus_*.xml";
