...
{
    /// <summary>
    /// Converts old DrvDbImportPlus configuration files to the current format.
    /// <para>Конвертирует старые файлы конфигурации DrvDbImportPlus в текущий формат.</para>
    /// </summary>
    internal sealed class ProjectConverter
    {
        ...
        private static void ConvertFile(string sourceFileName, string outputPath, ConverterOptions options)
        {
            ...
            DrvDbImportPlusProject project = ConvertProject(rootElem);
            ...
            DrvDbImportPlusProject savedProject = new DrvDbImportPlusProject();
        ...
        private static DrvDbImportPlusProject ConvertProject(XmlElement rootElem)
        {
            DrvDbImportPlusProject project = new DrvDbImportPlusProject();
            LoadDbConnSettings(rootElem, project.DbConnSettings);
            ...
            ImportCmd importCmd = new ImportCmd
            {
                ...
                CmdCode = "DBIMPORT001",
                Name = "Import",
                Description = "Converted from old DrvDbImportPlus configuration.",
