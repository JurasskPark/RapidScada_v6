...
namespace Scada.Comm.Drivers.DrvDbImportPlus
{
    ...
    public class DbConnSettings
    {
        ...
        public void LoadFromXml(XmlNode xmlNode)
        {
            ...
            DataSourceType = xmlNode.GetChildAsEnum<DataSourceType>("DataSourceType");
            ...
            Timeout = xmlNode.GetChildAsString("Timeout");
        }
        ...
        public void SaveToXml(XmlElement xmlElem)
        {
            ...
            xmlElem.AppendElem("DataSourceType", DataSourceType);
