...
using Scada.Comm.Drivers.DrvFtpJP.Logic;
...
namespace Scada.Comm.Drivers.DrvFtpJP.Logic
{
    ...
    /// </summary>
    public class DrvFtpJPLogic : DriverLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvFtpJPLogic(ICommContext commContext)
            : base(commContext)
        {
        }
        ...
        {
            return new DevTextParserInDatabaseJPLogic(CommContext, lineContext, deviceConfig);
        }
    }
}