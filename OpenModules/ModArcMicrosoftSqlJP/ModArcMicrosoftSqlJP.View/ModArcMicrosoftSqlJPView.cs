...
namespace Scada.Server.Modules.ModArcMicrosoftSqlJP.View
{
    ...
    /// </summary>
    public class ModArcMicrosoftSqlJPView : ModuleView
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public ModArcMicrosoftSqlJPView()
        {
        ...
        public override string Name
        {
            get
            {
                return Locale.IsRussian ?
                    "Архив Microsoft SQL Server" :
                    "Microsoft SQL Server Archive";
            }
        }
        ...
        public override string Descr
        {
            ...
            {
                return Locale.IsRussian ?
                    "Модуль обеспечивает архивирование данных в базу данных Microsoft SQL Server." :
                    "The module provides data archiving into Microsoft SQL Server database.";
            }
        }
        ...
        {
            return new MicrosoftSqlArchiveView(this, archiveConfig);
        }
    }
}
