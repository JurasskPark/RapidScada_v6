...
namespace Scada.Server.Modules.ModArcMicrosoftSqlJP.View.Forms
{
    partial class FrmConnManager
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ctrlDbConnection.TabIndex = 1;
            this.ctrlDbConnection.NameChanged += new System.EventHandler(this.ctrlDbConnection_NameChanged);
            this.ctrlDbConnection.NameValidated += new System.EventHandler(this.ctrlDbConnection_NameValidated);
            // 
            // FrmConnManager
            // 
            ...
            this.Controls.Add(this.ctrlDbConnection);
            ...
            this.Text = "Microsoft SQL Server Connections";
