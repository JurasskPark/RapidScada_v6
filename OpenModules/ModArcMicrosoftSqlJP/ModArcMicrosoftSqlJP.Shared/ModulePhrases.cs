...
namespace Scada.Server.Modules.ModArcMicrosoftSqlJP
{
    /// <summary>
    ...
    {
        // Scada.Server.Modules.ModArcMicrosoftSqlJP.Logic
        ...
        public static string RowsDeleted { get; private set; }
        ...
        static ModulePhrases()
        {
            if (Locale.IsRussian)
            {
                ...
                RowsDeleted = "Удалено устаревших строк: {0}. Операция выполнена за {1} мс";
            }
            else
            {
                ...
                RowsDeleted = "{0} outdated rows deleted in {1} ms";
            }
        }
    }
}
