...
namespace Scada.Server.Modules.ModArcMicrosoftSqlJP.Config
{
    /// <summary>
    /// Represents options of a historical data archive.
    /// <para>Представляет параметры архива исторических данных.</para>
    /// </summary>
    internal class MicrosoftSqlHAO : HistoricalArchiveOptions, IDatabaseOptions
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public MicrosoftSqlHAO(OptionList options)
            : base(options)
        {
            UseDefaultConn = options.GetValueAsBool("UseDefaultConn", false);
