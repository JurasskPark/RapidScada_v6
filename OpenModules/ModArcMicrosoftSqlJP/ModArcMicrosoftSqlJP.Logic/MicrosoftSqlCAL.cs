...
namespace Scada.Server.Modules.ModArcMicrosoftSqlJP.Logic
{
    ...
    /// </summary>
    internal class MicrosoftSqlCAL : CurrentArchiveLogic
    {
        ...
        /// </summary>
        public MicrosoftSqlCAL(IArchiveContext archiveContext, ArchiveConfig archiveConfig, int[] cnlNums,
        ...
        private void CreateDbEntities()
        {
            ...
            try
            {
                ...
                SqlCommand cmd2 = new(queryBuilder.CreateCurrentTableQuery, conn);
        ...
        public override void ReadData(ICurrentData curData, out bool completed)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new(sql, readingConn, trans);
                ...
                if (cnlsToDelete.Count > 0)
                {
                    ...
                    cmd = new SqlCommand(sql, readingConn, trans);
                    SqlParameter cnlNumParam = cmd.Parameters.Add("cnlNum", SqlDbType.Int);
