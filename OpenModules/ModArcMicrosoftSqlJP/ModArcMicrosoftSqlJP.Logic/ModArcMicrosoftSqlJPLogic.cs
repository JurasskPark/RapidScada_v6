...
namespace Scada.Server.Modules.ModArcMicrosoftSqlJP.Logic
{
    ...
    /// </summary>
    public class ModArcMicrosoftSqlJPLogic : ModuleLogic
    {
        ...
        /// </summary>
        public ModArcMicrosoftSqlJPLogic(IServerContext serverContext)
            : base(serverContext)
        {
            ...
            int[] cnlNums)
        {
            ...
            {
                ArchiveKind.Current => new MicrosoftSqlCAL(archiveContext, archiveConfig, cnlNums, moduleConfig),
                ArchiveKind.Historical => new MicrosoftSqlHAL(archiveContext, archiveConfig, cnlNums, moduleConfig),
                ArchiveKind.Events => new MicrosoftSqlEAL(archiveContext, archiveConfig, cnlNums, moduleConfig),
                _ => null,
            };
        }
