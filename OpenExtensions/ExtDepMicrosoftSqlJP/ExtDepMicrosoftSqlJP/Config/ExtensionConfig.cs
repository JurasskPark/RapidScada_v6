...
namespace Scada.Admin.Extensions.ExtDepMicrosoftSqlJP.Config
{
    /// <summary>
    ...
    internal class ExtensionConfig : ConfigBase
    {
        ...
        /// </summary>
        public const string DefaultFileName = "ExtDepMicrosoftSqlJP.xml";
        ...
        protected override void Save(TextWriter writer)
        {
            ...
            XmlElement rootElem = xmlDoc.CreateElement("ExtDepMicrosoftSqlJP");
